...
const HistoryGraph = ({ t, dir, themeName }) => (
    <Panel md={12} lg={12} xl={8} sm={12} xs={12} title={t('history.history_graph')}>
      <div dir="ltr">
...
export default connect(state => ({ themeName: state.theme.className }))(withTranslation('common')(HistoryGraph));
